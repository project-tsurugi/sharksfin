...
// NOLINTNEXTLINE
#define _LOCATION_PREFIX_TO_STREAM(stream)  if (constexpr auto __tmplp = sharksfin::shirakami::location_prefix(__PRETTY_FUNCTION__, __FUNCTION__); false) {} else stream << __tmplp.data()
// NOLINTNEXTLINE
